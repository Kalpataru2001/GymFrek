  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      {!m ? (
        ...
        <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={s.label} className="bg-gray-700 rounded-lg p-3 text-center">
                  ...
                  <p className="text-xl font-bold text-white">{s.value}<span className="text-xs text-gray-400 ml-1">{s.unit}</span></p>
                </div>
              ))}
            </div>
          ...
          <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
            <h2 className="text-lg font-semibold text-white mb-4">Calorie Distribution</h2>
          ...
          <div className="bg-gray-800 rounded-xl border border-gray-700 p-6 lg:col-span-2">
            <h2 className="text-lg font-semibold text-white mb-4">Your Metabolic Stats</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={s.label} className="bg-gray-700 rounded-lg p-4">
                  <p className="text-xs text-gray-400">{s.label}</p>
                  <p className="text-lg font-bold text-white mt-1 capitalize">{s.value} <span className="text-xs text-gray-400 font-normal">{s.unit}</span></p>
      ...
      <div className="flex gap-4">
        <Link href="/nutrition/food-calculator" className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-medium px-6 py-2.5 rounded-lg transition-colors">
