...
export function normalizeGymQuery(input: string): string {
  ...
  s = s.replace(/\btiredmill\b|\btiredmil\b|\btredmill\b|\btredmil\b|\btradmill\b/g, 'treadmill');
  s = s.replace(/\bcykling\b|\bbycycle\b|\bcycle\b|\bcycling\b|\bbike\b/g, 'cycling');
  s = s.replace(/\bcrosstrainer\b|\bcross\s+trainer\b|\bcross-trainer\b|\beliptical\b|\belliptical\b/g, 'cross trainer');
  s = s.replace(/\bpecflys\b|\bpecfly\b|\bpec\s+flys\b|\bpec\s+fly\b|\bpec-fly\b/g, 'pec fly');
  s = s.replace(/\biron\s*man\s*plank\b|\bironman\b/g, 'iron man plank');
  s = s.replace(/\bboth\s+arm\s+extension\b|\btwo\s+arm\s+extension\b/g, 'both arm extension');
  s = s.replace(/\bseated\s+rowing\b|\bseated\s+row\b/g, 'seated row');
...
export const EXERCISE_ALTERNATIVE_VIDEOS: Record<string, string[]> = {
  ...
  core_ironman_plank: ['ASdvN_XEl_c', '1919eP5nB_E', 'hdng3Nm1x_E', 'wkD8rjkodUI'],
  ...
  cardio_cycling: ['8BvL0m_Qp7A', 'j6K3L4vU5_w', 'auBLPXO8Fww', '3gK-mYmO6Qk'],
  cardio_crosstrainer: ['ZlYw2pB61lU', 'iSSAk4XCsRA', 'auBLPXO8Fww', '3gK-mYmO6Qk'],
...
export const USER_CUSTOM_WEEKLY_PLAN: WorkoutPlan = {
  level: 'intermediate',
  goal: 'improve_fitness',
  daysPerWeek: 6,
  planType: 'Custom 6-Day Machine, Strength & Cardio Split',
  weeklyProgressionNote: 'Increase machine pin weight or dumbbell weight each week; increase speed or resistance on cardio intervals.',
  schedule: [
    {
      day: 'Monday',
      focus: 'Upper Body & Machine Hypertrophy',
      isRestDay: false,
      exercises: [
        {
          ...
          rest: '60s',
          muscleGroup: 'Chest',
          instructions: 'Sit with handles at mid-chest height. Press handles forward smoothly until arms are extended without locking elbows, lower under 2-second control.',
          difficulty: 'beginner',
          videoUrl: 'xUm0BiKGcwE',
          alternativeVideos: ['xUm0BiKGcwE', 'rT7DgCr-3pg', 'VmB1G1K7v94'],
        ...
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Triceps',
          instructions: 'Grip straight bar or rope at upper chest. Keep upper arms pinned to sides and push downward until elbows fully lock out.',
          difficulty: 'beginner',
          videoUrl: 'vB5OHsJ3EME',
          alternativeVideos: ['vB5OHsJ3EME', '2-LAMcpzODU', '_gsUokN_Abg'],
          targetMuscles: ['Triceps Brachii (Lateral & Medial Heads)'],
          equipment: 'Cable Machine with Bar / Rope',
        },
        {
          name: 'Lat Pull Down',
          sets: 3,
          ...
          rest: '60s',
          muscleGroup: 'Back',
          instructions: 'Grip wide bar with overhand grip. Pull bar down towards upper collarbone, driving elbows down and squeezing lats.',
          difficulty: 'beginner',
          videoUrl: 'CAwf7n6Luuc',
          alternativeVideos: ['CAwf7n6Luuc', 'HNb446a8yK0', 'pYcpY20QaE8'],
          targetMuscles: ['Latissimus Dorsi', 'Biceps', 'Rhomboids'],
        ...
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Quads',
          instructions: 'Sit with pad against lower shins. Extend legs upward to full contraction, squeeze quads for 1 second, lower under control.',
          difficulty: 'beginner',
          videoUrl: 'm0Bg-w0j47Y',
          alternativeVideos: ['m0Bg-w0j47Y', '8kXWb1tU81Y', 'IZxyjW7MPJQ'],
          targetMuscles: ['Quadriceps'],
          equipment: 'Leg Extension Machine',
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Biceps',
          instructions: 'Stand facing low pulley with straight or EZ bar. Curl bar upward towards shoulders keeping elbows locked at sides.',
          difficulty: 'beginner',
          videoUrl: 'kwG2ipFRgfo',
          alternativeVideos: ['kwG2ipFRgfo', 'in7PaeYlhrM', 'zC3nLlEvin4'],
          targetMuscles: ['Biceps Brachii', 'Brachialis'],
          equipment: 'Low Cable Pulley with Bar',
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Shoulders',
          instructions: 'Sit tall with back supported. Press handles overhead smoothly until arms are extended, lower slowly to ear height.',
          difficulty: 'beginner',
          videoUrl: '2yjwXTZQDDI',
          alternativeVideos: ['2yjwXTZQDDI', 'qEwKCR5JCog', 'B-aVuyhvLHU'],
    ...
    {
      day: 'Tuesday',
      focus: 'Cardio & Conditioning Interval',
      isRestDay: false,
      exercises: [
        {
          ...
          rest: '60s',
          muscleGroup: 'Cardio & Conditioning',
          instructions: 'Set incline to 6-10% and maintain brisk 5-6 km/h pace or alternate 1 min jog with 1 min walk.',
          difficulty: 'beginner',
          videoUrl: '3gK-mYmO6Qk',
          alternativeVideos: ['3gK-mYmO6Qk', 'auBLPXO8Fww', 'nmwgirgXLYM'],
          targetMuscles: ['Cardiovascular System', 'Calves', 'Glutes'],
          equipment: 'Treadmill',
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Cardio & Conditioning',
          instructions: 'Maintain moderate pedal cadence (70-85 RPM) with medium magnetic resistance to keep heart rate in fat-burn zone.',
          difficulty: 'beginner',
          videoUrl: '8BvL0m_Qp7A',
          alternativeVideos: ['8BvL0m_Qp7A', 'j6K3L4vU5_w', 'auBLPXO8Fww'],
          targetMuscles: ['Cardiovascular System', 'Quadriceps', 'Hamstrings'],
          equipment: 'Stationary Exercise Bike',
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Cardio & Conditioning',
          instructions: 'Push and pull handles in sync with fluid leg strides at steady resistance for low-impact total body calorie burn.',
          difficulty: 'beginner',
          videoUrl: 'ZlYw2pB61lU',
          alternativeVideos: ['ZlYw2pB61lU', 'iSSAk4XCsRA', 'auBLPXO8Fww'],
          targetMuscles: ['Cardiovascular System', 'Full Body Cardio'],
          equipment: 'Cross Trainer / Elliptical',
        },
      ],
    },
    {
      day: 'Wednesday',
      focus: 'Dumbbell Full Body Strength',
      isRestDay: false,
      exercises: [
        {
          ...
          rest: '60s',
          muscleGroup: 'Quads / Glutes',
          instructions: 'Hold dumbbells at shoulders or goblet style at chest. Sit hips back and down until thighs are parallel to ground, drive through heels to stand.',
          difficulty: 'beginner',
          videoUrl: 'MeIiIdhvXT4',
          alternativeVideos: ['MeIiIdhvXT4', 'aclHkVaku9U', 'bEv6CCg2BC8'],
          targetMuscles: ['Quadriceps', 'Glutes', 'Core'],
        ...
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Shoulders',
          instructions: 'Hold dumbbells at shoulder height with palms facing forward. Press vertically overhead until arms lock out, lower with control.',
          difficulty: 'beginner',
          videoUrl: 'qEwKCR5JCog',
          alternativeVideos: ['qEwKCR5JCog', '2yjwXTZQDDI', 'B-aVuyhvLHU'],
          targetMuscles: ['Anterior Deltoids', 'Lateral Deltoids', 'Triceps'],
          equipment: 'Pair of Dumbbells',
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Biceps & Forearms',
          instructions: 'Hold dumbbells with neutral palms-facing-each-other grip. Curl weights towards shoulders keeping elbows stationary.',
          difficulty: 'beginner',
          videoUrl: 'zC3nLlEvin4',
          alternativeVideos: ['zC3nLlEvin4', 'kwG2ipFRgfo', 'in7PaeYlhrM'],
          targetMuscles: ['Brachialis', 'Brachioradialis', 'Biceps'],
          equipment: 'Pair of Dumbbells',
        },
        {
          name: 'Dumbbell Bentover Rowing',
          sets: 3,
          reps: '10-12',
          rest: '60s',
          muscleGroup: 'Back',
          instructions: 'Hinge hips back with torso angled 45 degrees. Pull dumbbells towards lower abdomen driving elbows back and squeezing shoulder blades.',
          difficulty: 'beginner',
          videoUrl: 'GZbfZ033f74',
          alternativeVideos: ['GZbfZ033f74', '9efgc2Wg0PQ', '6TSzcG1bZ8I'],
        ...
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Chest',
          instructions: 'Lie on flat bench with dumbbells over chest. Lower weights with elbows at 45 degrees until deep chest stretch, press back up to center.',
          difficulty: 'beginner',
          videoUrl: '4Y2ZdHCOXok',
          alternativeVideos: ['4Y2ZdHCOXok', 'rT7DgCr-3pg', 'vcBig73ojpE'],
          targetMuscles: ['Pectoralis Major', 'Anterior Deltoids', 'Triceps'],
          equipment: 'Flat Bench & Dumbbells',
        },
        {
          name: 'Dumbbell Both Arm Extension',
          sets: 3,
          reps: '12-15',
          rest: '60s',
          muscleGroup: 'Triceps',
          instructions: 'Hold one dumbbell vertically overhead with both hands under upper plate. Lower behind neck by bending elbows, press up to lockout.',
          difficulty: 'beginner',
          videoUrl: '_gsUokN_Abg',
          alternativeVideos: ['_gsUokN_Abg', 'vB5OHsJ3EME', '2-LAMcpzODU'],
    ...
    {
      day: 'Thursday',
      focus: 'Endurance Cardio Circuit',
      isRestDay: false,
      exercises: [
        {
          name: 'Treadmill 2km Run / Incline Walk',
          sets: 1,
          reps: '2 km',
          rest: '60s',
          muscleGroup: 'Cardio & Conditioning',
          instructions: 'Run at steady 8-10 km/h or power walk on 8% incline until completing 2 kilometers for cardiovascular conditioning.',
          difficulty: 'beginner',
          videoUrl: '3gK-mYmO6Qk',
          alternativeVideos: ['3gK-mYmO6Qk', 'auBLPXO8Fww', 'nmwgirgXLYM'],
          targetMuscles: ['Cardiovascular System', 'Calves', 'Quads'],
          equipment: 'Treadmill',
        },
        {
          name: 'Cross Trainer',
          ...
          rest: '60s',
          muscleGroup: 'Cardio & Conditioning',
          instructions: 'Maintain consistent 60+ RPM cadence with active push/pull arm movement for continuous fat burning.',
          difficulty: 'beginner',
          videoUrl: 'ZlYw2pB61lU',
          alternativeVideos: ['ZlYw2pB61lU', 'iSSAk4XCsRA', 'auBLPXO8Fww'],
          targetMuscles: ['Cardiovascular System', 'Full Body Cardio'],
        ...
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Cardio & Conditioning',
          instructions: 'Finish cardio session with 10 minutes of moderate-to-high intensity cycling intervals.',
          difficulty: 'beginner',
          videoUrl: '8BvL0m_Qp7A',
          alternativeVideos: ['8BvL0m_Qp7A', 'j6K3L4vU5_w', 'auBLPXO8Fww'],
          targetMuscles: ['Cardiovascular System', 'Quads', 'Hamstrings'],
    ...
    {
      day: 'Friday',
      focus: 'Strength & Machine Hypertrophy',
      isRestDay: false,
      exercises: [
        {
          name: 'Leg Curl',
          ...
          rest: '60s',
          muscleGroup: 'Hamstrings',
          instructions: 'Lie prone or seated on leg curl machine. Curl heels back towards buttocks, squeeze peak contraction for 1 second, lower slowly.',
          difficulty: 'beginner',
          videoUrl: '8kXWb1tU81Y',
          alternativeVideos: ['8kXWb1tU81Y', 'm0Bg-w0j47Y', 'IZxyjW7MPJQ'],
          targetMuscles: ['Hamstrings', 'Calves'],
          equipment: 'Hamstring Leg Curl Machine',
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Shoulders',
          instructions: 'Hold dumbbells in front of thighs. Raise weights forward to shoulder height with straight arms, lower with 2-second control.',
          difficulty: 'beginner',
          videoUrl: 'hRJ6EB5-5jY',
          alternativeVideos: ['hRJ6EB5-5jY', 'q8m_iX46q_U', '2yjwXTZQDDI'],
          targetMuscles: ['Anterior Deltoids', 'Upper Chest'],
          equipment: 'Pair of Dumbbells',
        },
        {
          name: 'Machine Pec Flyes',
          sets: 3,
          reps: '12-15',
          rest: '60s',
          muscleGroup: 'Chest',
          instructions: 'Sit with back flat on pad. Bring arms together in front of chest in a hugging motion, squeeze pectorals tightly at center.',
          difficulty: 'beginner',
          videoUrl: 'Iwe6AmxVf7o',
          alternativeVideos: ['Iwe6AmxVf7o', 'eozdVDA78K0', 'rr6eFNNDQJE'],
          targetMuscles: ['Pectoralis Major (Sternal & Clavicular)'],
        ...
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Biceps',
          instructions: 'Curl dumbbells upward rotating wrists outward (supinating) to maximize biceps peak contraction.',
          difficulty: 'beginner',
          videoUrl: 'in7PaeYlhrM',
          alternativeVideos: ['in7PaeYlhrM', 'kwG2ipFRgfo', 'zC3nLlEvin4'],
        ...
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Chest',
          instructions: 'Press handles forward to near full extension, hold for a split second and lower slowly feeling the chest stretch.',
          difficulty: 'beginner',
          videoUrl: 'xUm0BiKGcwE',
          alternativeVideos: ['xUm0BiKGcwE', 'rT7DgCr-3pg', 'VmB1G1K7v94'],
          targetMuscles: ['Pectoralis Major', 'Triceps', 'Front Delts'],
        ...
        {
          name: 'Machine Seated Rowing',
          sets: 3,
          reps: '10-12',
          rest: '60s',
          muscleGroup: 'Back',
          instructions: 'Sit upright against chest support pad. Pull handles back driving elbows past ribs and squeezing mid-back muscles.',
          difficulty: 'beginner',
          videoUrl: '6TSzcG1bZ8I',
          alternativeVideos: ['6TSzcG1bZ8I', 'GZbfZ033f74', '9efgc2Wg0PQ'],
          targetMuscles: ['Latissimus Dorsi', 'Rhomboids', 'Trapezius', 'Biceps'],
          equipment: 'Machine Seated Row',
        },
      ],
    },
    {
      day: 'Saturday',
      focus: 'Cardio & Core Burn',
      isRestDay: false,
      exercises: [
        {
          name: 'Stationary Cycling',
          ...
          rest: '60s',
          muscleGroup: 'Cardio & Conditioning',
          instructions: 'Cycle for 20 minutes with steady resistance to burn calories and warmup leg muscles.',
          difficulty: 'beginner',
          videoUrl: '8BvL0m_Qp7A',
          alternativeVideos: ['8BvL0m_Qp7A', 'j6K3L4vU5_w', 'auBLPXO8Fww'],
          targetMuscles: ['Cardiovascular System', 'Quadriceps', 'Calves'],
          equipment: 'Stationary Exercise Bike',
        },
        {
          name: 'Crunches',
          ...
          rest: '45s',
          muscleGroup: 'Core / Abs',
          instructions: 'Lie on floor with knees bent. Contract upper abs to curl shoulder blades off ground, exhaling at peak crunch.',
          difficulty: 'beginner',
          videoUrl: 'wkD8rjkodUI',
          alternativeVideos: ['wkD8rjkodUI', '1919eP5nB_E', 'hdng3Nm1x_E'],
        ...
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Cardio & Conditioning',
          instructions: '10-minute steady-state cross trainer interval to keep heart rate elevated.',
          difficulty: 'beginner',
          videoUrl: 'ZlYw2pB61lU',
          alternativeVideos: ['ZlYw2pB61lU', 'iSSAk4XCsRA', 'auBLPXO8Fww'],
          targetMuscles: ['Cardiovascular System', 'Full Body Cardio'],
        ...
        },
        {
          ...
          rest: '45s',
          muscleGroup: 'Core / Abs',
          instructions: 'Lie flat on back with hands stabilizing hips. Raise straight legs up to 90 degrees, lower under control without arching lower back.',
          difficulty: 'beginner',
          videoUrl: 'l4kQd9x9WKI',
          alternativeVideos: ['l4kQd9x9WKI', 'Pr1ieGZ5atk', 'hdng3Nm1x_E', 'JB2oyawG9KI'],
          targetMuscles: ['Rectus Abdominis (Lower Abs)', 'Hip Flexors'],
          equipment: 'Mat / Floor',
        },
        {
          name: 'Treadmill Walking / Jog',
          sets: 1,
          reps: '10 minutes',
          rest: '60s',
          muscleGroup: 'Cardio & Conditioning',
          instructions: '10-minute cooldown incline walk or light jog on the treadmill.',
          difficulty: 'beginner',
          videoUrl: '3gK-mYmO6Qk',
          alternativeVideos: ['3gK-mYmO6Qk', 'auBLPXO8Fww', 'nmwgirgXLYM'],
          targetMuscles: ['Cardiovascular System', 'Calves', 'Glutes'],
        ...
        },
        {
          ...
          rest: '60s',
          muscleGroup: 'Core / Abs',
          instructions: 'Hold a rigid plank with arms extended slightly further in front of shoulders, bracing core and glutes intensely for 60 seconds.',
          difficulty: 'intermediate',
          videoUrl: 'ASdvN_XEl_c',
          alternativeVideos: ['ASdvN_XEl_c', '1919eP5nB_E', 'hdng3Nm1x_E', 'wkD8rjkodUI'],
